                                            ...
                                            <div className="card-options__inner">
                                                <a className="card-options__link" href="group-profile.html">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                        ...
                                                        <path d="M6 8.66669H10" stroke="#0E1218" strokeWidth="1.5"
                                        ...
                                        <ul className="card__list card-list">
                                            ...
                                            <li className="card-list__item">
                                                <a className="card-list__link" href="courses-page.html">
                                                    by Anthony Clark
                                                    <img className="card-list__link-img" src="images/member-icon-6.png"
                                                        alt="img" />
                                                </a>
                                            </li>
                                        </ul>
                                        <a className="card-box__poster" href="courses-page.html">
                                            <img className="card-box__poster-img" src="images/course-img-2.jpg" alt="img" />
                                    ...
                                    <div className="card__inner">
                                        ...
                                        <ul className="card__list card-list">
                                            ...
                                            <li className="card-list__item">
                                                <a className="card-list__link" href="courses-page.html">
                                                    by Philippa Bush
                                                    <img className="card-list__link-img" src="images/member-icon-3.png"
                                                        alt="img" />
                                                </a>
                                            </li>
                                        </ul>
                                        <a className="card-box__poster" href="courses-page.html">
                                            <img className="card-box__poster-img" src="images/course-img-3.jpg" alt="img" />
                                            <p className="card-box__poster-text">
                                                $20
                                            </p>
                                        </a>
                  ...
                  <div className="portfolio_main">
                      ...
                      <div className="works_list works_list_col3 ">
                          ...
                          <div className="work__shout">
                                           <a className="work__link-img" href="members-portfolio-single.html">
                                               <img src="images/new/ga1.jpg" alt="img" />
                                               <div className="work__link-image-caption">Wallet App design</div>
                                            </a>
                                            <div className="work__link-image-user">
                                                <div className="work__link-image-avatar">
                                             <img className="members-section-top__img-image" src="images/member-icon-16.png" alt="img" />
                                               </div>
                                               <a href="members-portfolio-single.html"> Elodie Hardin</a></div> 
                                        </div>
                ...
                <div className="container">
                    <div className="section-top__inner">
                        ...
                        <div className="section-top__img">
                            <img className="section-top__img-image" src="images/new/image8885.jpg" alt="img" />
                        </div>
                    </div>
                </div>
            </div>
            <section className="main__shop-section shop-section">
                <div className="container">
                    <div className="shop-section__top shop-section-top">
                        <h2 className="shop-section-top__title">
                            Our Shop
                        </h2>
                        ...
                        <div className="swiper-wrapper">
                                ...
                                <div className="news-section-slide__card card">
                                    <div className="card__inner">
                                        ...
                                        <ul className="card__list card-list">
                                            ...
                                            <li className="card-list__item">
                                                <a className="card-list__link" href="blog-page.html">
                                                    by Timothy Stuart
                                                    <img className="card-list__link-img" src="images/member-icon-15.png"
                                                        alt="img" />
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div className="news-section-swiper__slide news-section-slide swiper-slide">
                                <div className="news-section-slide__card card">
                                    <div className="card__inner">
                                        <a className="card-box__poster" href="blog-page.html">
                                            <img className="card-box__poster-img" src="images/group-img-18.jpg" alt="img" />
                                        </a>
                                        <p className="card__suptext card__suptext--purple">
                                            marketing
                                        </p>
                ...
                <div className="login__inner">
                    ...
                    <div className="login__info login-info">
                        <div className="login-info__box">
                            <p className="login-info__box-text">
                                Username:
                            </p>
                            ...
                            <button className="login-info__box-btn" onClick="copyToClipboard1()">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons" clipPath="url(#clip0_215_18476)">
                                        <path id="Vector" d="M13.3333 5.33325H6.66659C5.93021 5.33325 5.33325 5.93021 5.33325 6.66659V13.3333C5.33325 14.0696 5.93021 14.6666 6.66659 14.6666H13.3333C14.0696 14.6666 14.6666 14.0696 14.6666 13.3333V6.66659C14.6666 5.93021 14.0696 5.33325 13.3333 5.33325Z" stroke="#6D9985" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path id="Vector_2" d="M2.66659 10.6666C1.93325 10.6666 1.33325 10.0666 1.33325 9.33325V2.66659C1.33325 1.93325 1.93325 1.33325 2.66659 1.33325H9.33325C10.0666 1.33325 10.6666 1.93325 10.6666 2.66659" stroke="#6D9985" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </g>
                                    <defs>
                        ...
                        <div className="login-info__box">
                            ...
                            <button className="login-info__box-btn" onClick="copyToClipboard2()">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="icons" clipPath="url(#clip0_215_18476)">
                                        <path id="Vector" d="M13.3333 5.33325H6.66659C5.93021 5.33325 5.33325 5.93021 5.33325 6.66659V13.3333C5.33325 14.0696 5.93021 14.6666 6.66659 14.6666H13.3333C14.0696 14.6666 14.6666 14.0696 14.6666 13.3333V6.66659C14.6666 5.93021 14.0696 5.33325 13.3333 5.33325Z" stroke="#6D9985" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        <path id="Vector_2" d="M2.66659 10.6666C1.93325 10.6666 1.33325 10.0666 1.33325 9.33325V2.66659C1.33325 1.93325 1.93325 1.33325 2.66659 1.33325H9.33325C10.0666 1.33325 10.6666 1.93325 10.6666 2.66659" stroke="#6D9985" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <form className="login__form login-form" action="#">
                        <div className="login-form__box login-form-box">
                            ...
                            <div className="login-form-box__row">
                                <input className="login-form-box__row-input" type="text" />
                            </div>
                        </div>
                        <div className="login-form__box login-form-box">
                            <label className="login-form-box__label" htmlFor="">
                            ...
                            <div className="login-form-box__row">
                                <input className="login-form-box__row-input" type="password" />
                        ...
                        <div className="login-form__bottom">
                            ...
                            <a className="login-form__bottom-link" href="#">
                                Forgot Password?
                            </a>
                        </div>
            ...
            <section className="main__popup " id="faq-popup">
                <div className="popup__inner">
                    ...
                    <div className="popup-content">
                        ...
                        <ul>
                            <li><i className="icon-book-open"></i><a href="index.html">How to Upload Your Portfolio </a></li>
                            <li><i className="icon-book-open"></i><a href="index.html">How to Start To Work</a></li>
                            <li><i className="icon-book-open"></i><a href="index.html">Get in touch with the Creator Support Team</a></li>
                        </ul>
                        <div className="form-help-links">
                            <a className="fl-btn btn_first" href="index.html">Browse all articles</a>
                            <a className="fl-btn btn_second" data-fancybox="" href="#report-popup">Send Feedback</a>
                        </div>
                ...
                <div className="popup__inner">
                    ...
                    <div className="popup-content">
                        <div id="send-feedback">
                            <input className="fl-input" type="text" placeholder="Your Name" />
                            <input className="input" type="text" placeholder="Your Email" />
                            <textarea className="fl-textarea" placeholder="Your Comment" rows="3"></textarea>
                            <button className="comment__form-btn" type="button">
                                Send Message
                            </button>
                        </div>
                    </div>
